...
/**
 * <h3>Description :</h3> This is the Starter class of the entire
 * application
 * @author Karthik
 *
 */
public class WellsBank {
	...
	/**
	 * <h3>Description :</h3> The starter method of the entire
	 * application
	 * @param args the command line arguments for the application
	 */
	public static void main(String[] args) {
		//creating new customer and adding to the list
	...
	/**
	 * <h3>Description :</h3> This method is used to print the details
