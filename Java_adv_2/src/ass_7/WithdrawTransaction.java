...
/**
 * This file contains the Withdraw transaction class
 */

/**
 * <h3>Description :</h3> This class is used to perform the withdrawal
 * trasaction in the Wells Bank
 * @author Karthik
 */
...
public class WithdrawTransaction extends Security implements Runnable{
	 ...
	 */
	public WithdrawTransaction(int transactionId,Account
	...
	/**
	 * <h3>Description :</h3> This method does the withdrawal from
	 * the account
	 * @param account the account from which the withdrawal has to be
	 * done
