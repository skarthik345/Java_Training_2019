/**
* This file contains the Deposit Transaction class
*/
package ass_6;


/**
 * <h3>Description :</h3>This class contains methods for depositing the amount
 * into an account
 * 
 * @author E&R Dept, Krishna.
 */
public class DepositTransaction extends Thread {
     ...
     * @param account       the account to which the amount has to be deposited
     * @param customerId    the customer id of the customer depositing the amount
