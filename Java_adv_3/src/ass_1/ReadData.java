...
public class ReadData {
	/**
Krishna Java Training Lab Guide for Business Tier using POJO
	 * <h3>Description :</h3> This method is used to read data from
the
	 * console. Pressing the return key is used to specify the end of
the
	...
	public static String acceptString() {
		...
		data String stringData = null;
		//creating a reference for the buffered
		reader BufferedReader input = null;
		try {
			...
			//checking if the reader is closed to close
			it if(input!=null){
				//closing the input
				input=null;
			}
